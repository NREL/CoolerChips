%
% Module: ParaPower MATLAB Side API (Used by ParaPower Python Side)
% Authors:
% - Najee Stubbs {njstubbs@uark.edu}, University of Arkansas, Mechanical Engineering Dept.
% Date: June 26, 2024*
%
...
function addMaterials(configFilePath, baseDir)
    ...
    % Define the path to the original material library file in the TSRM_ParaPower folder
    originalMaterialFile = fullfile(baseDir, 'DefaultMaterials.mat');
